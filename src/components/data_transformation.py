...
class DataTransformationConfig:
    """
    Configuration class for storing preprocessing artifact paths.
    """
...
class DataTransformation:
    ...
    def get_cols_preprocess(self):
        """
        This function identifies categorical and numerical columns,
        then creates preprocessing pipelines for both types.
        """
        try:
    ...
    def initiate_data_transformation(self, train_path, valid_path, test_path):
        """
        Applies preprocessing to training, validation, and test datasets.
        """
        try:
            ...
            logging.info("Read and loaded train, validation, and test data")
            ...
            logging.info("Saving preprocessing object to artifacts")
